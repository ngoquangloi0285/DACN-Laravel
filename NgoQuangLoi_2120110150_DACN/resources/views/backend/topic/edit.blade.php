                ...
                <div class="card">
                        ...
                        <div class="container text-center">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <a href="{{ route('topic.index') }}" class="btn btn-sm btn-primary"><i
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        value="{{ old('name', $topic->name) }}" id="name" aria-describedby="emailHelp"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" id="metakey" class="form-control" placeholder="Nhập vào từ khóa tìm kiếm">{{ old('metakey', $topic->metakey) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metadesc" id="metadesc" class="form-control" placeholder="Nhập vào mô tả">{{ old('metadesc', $topic->metadesc) }}</textarea>
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>Đã cập nhật!, vào lúc <i> {{ $topic->updated_at }}</i> bởi ID
                                <i>{{ $topic->updated_by }}</i></strong>
