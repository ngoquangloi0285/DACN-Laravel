    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>CHỦ ĐỀ SỰ KIỆN</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Chủ đề sự kiện</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="container text-center">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="{{ route('topic.create') }}" class="btn btn-warning btn-sm"><i
                                        class="fa-solid fa-plus"></i> Tạo mới</a>
                                <a href="{{ route('topic.topic_trash') }}" style="text-decoration: none" class="btn-trash btn-sm">
