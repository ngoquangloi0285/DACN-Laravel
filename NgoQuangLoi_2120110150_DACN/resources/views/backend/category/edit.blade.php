                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        value="{{ old('name', $category->name) }}" id="namecategory"
                                        aria-describedby="emailHelp" placeholder="Nhập vào tên danh mục"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" id="metakey" class="form-control" placeholder="Nhập vào từ khóa tìm kiếm">{{ old('metakey', $category->metakey) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metadesc" id="metadesc" class="form-control" placeholder="Nhập vào mô tả">{{ old('metadesc', $category->metadesc) }}</textarea>
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>Đã cập nhật!, vào lúc <i> {{ $category->updated_at }}</i> bởi ID <i>{{ $category->updated_by }}</i></strong>
