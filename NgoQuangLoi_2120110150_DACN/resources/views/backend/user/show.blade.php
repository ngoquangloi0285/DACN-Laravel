                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('user.index') }}">Quay về</a></li>
                            <li class="breadcrumb-item active">Hồ hơ người dùng</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body box-profile">
                                ...
                                <p class="text-muted text-center">updating...</p>

                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item">
                                        <b>Followers</b> <a class="float-right">updating...</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Following</b> <a class="float-right">updating...</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Friends</b> <a class="float-right">updating...</a>
                                    </li>
                                </ul>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">
                                    <span class="tag tag-danger">updating...</span>
                                </p>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <form action="{{ route('user.store') }}" enctype="multipart/form-data" method="POST" class="form-horizontal">
                                            @csrf
