...
@section('title', 'Tạo thông báo sự kiện')
{{-- @php
    dd($list_category);
@endphp --}}
@section('content')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Tạo thông báo sự kiện</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="title"
                                            placeholder="Nhập vào tiêu đề" value="{{ old('title') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="detail" id="detail" class="form-control" rows="1" placeholder="Nhập vào nội dung">{{ old('detail') }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="metakey" id="metakey" class="form-control" rows="1" placeholder="Nhập vào từ khóa">{{ old('metakey') }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="metadesc" id="metadesc" class="form-control" rows="1" placeholder="Nhập vào mô tả">{{ old('metadesc') }}</textarea>
