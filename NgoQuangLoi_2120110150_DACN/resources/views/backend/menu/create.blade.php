                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Thêm cấp menu</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ old('name') }}"
                                        id="name" aria-describedby="emailHelp" placeholder="Nhập vào tên menu">
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="link" class="form-control" value="{{ old('slug') }}"
                                        id="slug" aria-describedby="emailHelp" placeholder="Nhập vào slug menu">
                                    @if ($errors->has('slug'))
